...
var getMatchMapStats = function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var getMatchInfoRowValues, getPlayerTopStat, _b, m$, p$, link, matchPageID, map, date, team1, team2, event, teamStatProperties, teamStats, mostXProperties, mostX, overview, fullRoundHistory, _c, rh1, rh2, roundHistory, playerPerformanceStats, playerOverviewStats, playerStats, performanceOverview;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    link = m$('.match-page-link').attr('href');
                    matchPageID = link === undefined ? -1 : Number(link.split('/')[2]);
